var bankcardList = [{
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/youzhengBig.png',
        imgIcon: '/waiwei/img/youzheng.png'
    }
}, {
    bankName: "工商银行",
    bankCode: "ICBC",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/gongshangBig.png',
        imgIcon: '/waiwei/img/gongshang.png'
    }
}, {
    bankName: "农业银行",
    bankCode: "ABC",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/nongyeBig.png',
        imgIcon: '/waiwei/img/nongye.png'
    }
}, {
    bankName: "中国银行",
    bankCode: "BOC",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/zhongguoBig.png',
        imgIcon: '/waiwei/img/zhongguo.png'
    }
}, {
    bankName: "建设银行",
    bankCode: "CCB",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/jiansheBig.png',
        imgIcon: '/waiwei/img/jianshe.png'
    }
}, {
    bankName: "交通银行",
    bankCode: "COMM",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/jiaotongBig.png',
        imgIcon: '/waiwei/img/jiaotong.png'
    }
}, {
    bankName: "招商银行",
    bankCode: "CMB",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/zhaoshangBig.png',
        imgIcon: '/waiwei/img/zhaoshang.png'
    }
}, {
    bankName: "民生银行",
    bankCode: "CMBC",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/minshengBig.png',
        imgIcon: '/waiwei/img/minsheng.png'
    }
}, {
    bankName: "光大银行",
    bankCode: "CEB",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/guangdaBig.png',
        imgIcon: '/waiwei/img/guangda.png'
    }
}, {
    bankName: "中信银行",
    bankCode: "CITIC",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/zhongxinBig.png',
        imgIcon: '/waiwei/img/zhongxin.png'
    }
}, {
    bankName: "华夏银行",
    bankCode: "HXBANK",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/huaxiaBig.png',
        imgIcon: '/waiwei/img/huaxia.png'
    }
}, {
    bankName: "平安银行",
    bankCode: "SPABANK",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/pinganBig.png',
        imgIcon: '/waiwei/img/pingan.png'
    }
}, {
    bankName: "兴业银行",
    bankCode: "CIB",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/xingyeBig.png',
        imgIcon: '/waiwei/img/xingye.png'
    }
}, {
    bankName: "上海银行",
    bankCode: "SHBANK",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/shanghaiBig.png',
        imgIcon: '/waiwei/img/shanghai.png'
    }
}, {
    bankName: "浦发银行",
    bankCode: "SPDB",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/pufaBig.png',
        imgIcon: '/waiwei/img/pufa.png'
    }
}, {
    bankName: "广发银行",
    bankCode: "GDB",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/guangfaBig.png',
        imgIcon: '/waiwei/img/guangfa.png'
    }
}, {
    bankName: "渤海银行",
    bankCode: "BOHAIB",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/jiangsuBig.png',
        imgIcon: '/waiwei/img/jiangsu.png'
    }
}, {
    bankName: "南京银行",
    bankCode: "NJCB",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/nanjingBig.png',
        imgIcon: '/waiwei/img/nanjing.png'
    }
}, {
    bankName: "宁波银行",
    bankCode: "NBBANK",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/beijingBig.png',
        imgIcon: '/waiwei/img/beijing.png'
    }
}, {
    bankName: "北京农村商业银行",
    bankCode: "BJRCB",
    ...
    imgUrl: {
        imgUrlBig: '/waiwei/img/hangzhouBig.png',
        imgIcon: '/waiwei/img/hangzhou.png'
    }
}, {
    bankName: "苏州市商业银行",
    bankCode: "JSBANK",
...
// 根据卡号输出所属银行图片
function getBankImgByCardNo(cardNo) {
    for (var i = 0, len = bankcardList.length; i < len; i++) {
        var bankcard = bankcardList[i];
        var imgurl = bankcard.imgUrl;
        var patterns = bankcard.patterns;
        for (var j = 0, jLen = patterns.length; j < jLen; j++) {
            var pattern = patterns[j];
            if ((new RegExp(pattern.reg)).test(cardNo)) {
                ...
                if (imgurl) {
                    ...
                    return {
                        imgUrlBig: '/waiwei/img/emptyIcon.png',
                        imgIcon: '/waiwei/img/emptyIcon.png'
                    };
                }
            }
        }
...
// 根据银行名称输出所属银行图片
function getBankImgByBankName(bankName) {
    for (var i = 0, len = bankcardList.length; i < len; i++) {
        var bankcard = bankcardList[i];
        var imgurl = bankcard.imgUrl;
        if (bankName == bankcard.bankName) {
            if (imgurl) {
                return imgurl;  //返回银行
            } else {
                return {
